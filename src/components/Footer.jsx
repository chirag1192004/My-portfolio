            ...
            <div className="container">
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 2fr', gap: '50px', borderBottom: '1px solid var(--color-tag-bg)', paddingBottom: '30px', marginBottom: '20px' }}>
                    ...
                    <div>
                        ...
                        <p style={{ color: 'var(--color-text-light)', marginBottom: '15px', display: 'flex', alignItems: 'center' }}><FontAwesomeIcon icon={faGlobe} style={{ fontSize: '1.2rem', color: 'var(--color-primary)', marginRight: '15px' }} /> Remote , India</p>
